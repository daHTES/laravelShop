        ...
        >
            <div>
                ...
                <div class="input-group row">
                    ...
                    <div class="col-sm-6">
                        @include('auth.layouts.errors', ['fieldName' => 'code'])
                ...
                <div class="input-group row">
                    ...
                    <div class="col-sm-6">
                        @include('auth.layouts.errors', ['fieldName' => 'description'])
                ...
                <div class="input-group row">
                    ...
                    <div class="col-sm-2">
                        @include('auth.layouts.errors', ['fieldName' => 'price'])
                    ...
                    <div class="input-group row">
                        ...
                        <div class="col-sm-2">
                            @include('auth.layouts.errors', ['fieldName' => 'count'])
